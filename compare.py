...
t2 = measure_time(script=["./run_clang.sh"], init_script=["./compile_clang.sh"], final_script=["make", "clean"], iteration=iteration)
...
# print("--------------")
print("CLANG - Execution time (second/iter): " + str(t2))
